...
![[Pasted image 20260917155421.png]]
![[Pasted image 20260917155437.png]]
...
![[Pasted image 20260917155519.png]]
...
声明：**速度** 和 **句柄**
![[Pasted image 20260917163628.png]]

记得获取 Compute Shader 核函数索引
![[Pasted image 20260917164157.png]]

同样的，记得进行 **实时的参数同步**
![[Pasted image 20260917164451.png]]

调用Advect();
![[Pasted image 20260917165346.png]]
##### （1）为什么有input和output？
...
声明： **句柄**
![[Pasted image 20260917164930.png]]
...
效果：
![[屏幕录制 2026-09-17 173020.mp4]]

如何结合贴图实现？

C#端：
创建颜色缓冲区：画面颜色创建了两个支持读写的 RenderTexture（`col0` 和 `col1`）
![[Pasted image 20260917173255.png]]

注入初始图像：
![[Pasted image 20260917173318.png]]

绑定内核：
![[Pasted image 20260917173450.png]]

调用Display（）：
![[Pasted image 20260917173539.png]]
...
![[Pasted image 20260917174349.png]]


![[Pasted image 20260917174406.png]]

所以我们需要用更平滑的采样方式，线性插值来采样


![[Pasted image 20260917174827.png]]

![[Pasted image 20260917174845.png]]

advect这里顺便也改一下
![[Pasted image 20260917175556.png]]

同样的display
![[Pasted image 20260917175854.png]]


平滑效果：
![[屏幕录制 2026-09-17 180200 1.mp4]]
...
![[Pasted image 20260917213601.png]]
...
![[Pasted image 20260917213838.png]]

InitComputeShader()中记得获取 Compute Shader 核函数索引

调用：

![[Pasted image 20260917214423.png]]
增加迭代次数：


![[Pasted image 20260917221457.png]]
...
![[Pasted image 20260917215402.png]]
分别对应：网格中间向左偏移一格，向右偏移一格，向上偏移一格，向下偏移一格


![[Pasted image 20260917224907.png]]
...
![[Pasted image 20260917220731.png]]
...
![[Pasted image 20260917223856.png]]
散度 = 右 - 左 + 上 - 下



![[Pasted image 20260917224438.png]] 


ComputeShader端：

声明一个新的 div RT贴图![[Pasted image 20260917224640.png]]


定义 halfdx ：这是流体模拟中计算散度（Divergence）时，中心差分（Central Difference）公式里提取出来的**常数系数** $\frac{1}{2\Delta x}$

![[Pasted image 20260917224944.png]]


线程拿到周围四领域的数值

![[Pasted image 20260917224829.png]]
...
![[Pasted image 20260917223819.png]]
...
![[屏幕录制 2026-09-17 230412.mp4]]

#### 4.3 速度场修正 (Gradient)

有了压力分布，根据“水往低压处流”，我们计算压力的梯度（即压差），并从原来的速度里减去它。

![[Pasted image 20260917224151.png]]


![[Pasted image 20260917230300.png]]
